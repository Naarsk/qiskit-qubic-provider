...
class QUBICProvider():
    ...
    .. code-block:: python
        ...
        from qiskit_qubic_provider import QUBICProvider

        qubic = QUBICProvider('MY_TOKEN')

        backend = qubic.backends.qubic_qasm_simulator

    where `'MY_TOKEN'` is the access token provided by QUBIC.
